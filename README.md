...
The project was built from scratch and memory of things I’ve learned over the years at SNHU.  It is the perfect artifact to showcase an array data structure.  It was not an enhancement of a previous project, but the creation of an idea I wanted to pursue.  The challenges I faced in this project were getting the spacing right, making sure all the variables were properly named, and getting the data to pull to the right places.
